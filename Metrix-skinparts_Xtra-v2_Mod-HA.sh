...
cd /tmp
set -e 
 wget "https://raw.githubusercontent.com/Ham-ahmed/Skins/main/MetrixFHD-Skin_with-parts.tar.gz"
wait
tar -xzf MetrixFHD-Skin_with-parts.tar.gz  -C /
wait
cd ..
set +e
rm -f /tmp/MetrixFHD-Skin_with-parts.tar.gz
sleep 2;
echo "" 
echo "" 
echo "**************************************************************************************************"
